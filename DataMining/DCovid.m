...
% Last Modified by GUIDE v2.5 27-May-2020 13:26:44
...
function sule_Callback(hObject, eventdata, handles)
% hObject    handle to sule (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
set(handles.sule, 'string', nilai);
% Hints: get(hObject,'String') returns contents of sule as text
%        str2double(get(hObject,'String')) returns contents of sule as a double


% --- Executes during object creation, after setting all properties.
function sule_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sule (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in sule.
